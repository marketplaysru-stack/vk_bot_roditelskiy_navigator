...
log("🚀 Запуск бота для Родительского навигатора (с очисткой расписания)")
...
def add_test_post_if_empty():
    ...
    if not has_parent:
        ...
        schedule.append({
            ...
            "niche": "родительский",
            "topic": "Тестовый пост для Родительского навигатора (гиперреалистичный)",
            "time": test_time,
            "done": False
        })
        save_schedule(schedule)
...
if __name__ == "__main__":
    log("🤖 Бот для Родительского навигатора (с очисткой расписания) запущен")
